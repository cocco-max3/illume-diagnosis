...
export const questions: Question[] = [
  ...
  },
  {
    id: "steps-too-big",
    key: "steps",
    text: "やることが大きな塊のままで、5ふんサイズまで小さくできていない感じですか？",
    options: [
...
export const resultMap: Record<AnswerKey, DiagnosisResult> = {
  info: {
    ...
    nextAction:
      "今日は、新しい情報を開かずに、今ある候補を3つだけ紙に出してください。その中から「5ふんだけ試せるもの」をひとつ選べたら十分です。",
  ...
  steps: {
    ...
    nextAction:
      "今日は、完成まで考えずに最初の動詞だけ決めてください。開く、書く、置く、送る。そのどれか1つを5ふんだけで十分です。",
  ...
  emotion: {
    ...
    nextAction:
      "今日は、「誰にも見せない前提」で5ふんだけ思考整理の時間を作ってください。完成ではなく、動いた痕跡だけで十分です。",
    nextActionVariants: [
      "今日は、「誰にも見せない前提」で5ふんだけ思考整理の時間を作ってください。完成ではなく、動いた痕跡だけで十分です。",
      "今日は、誰かに説明するためではなく、自分のために5ふんだけ気持ちをほどく時間を置いてください。",
      "今日は、形にする前に5ふんだけ「何が怖いのか」を一文にする時間を作ってください。",
      "今日は、完成させる時間ではなく、頭の中を少し外へ出す5ふんだけを取ってください。",
      "今日は、うまくやる準備ではなく、今の不安に名前をつける5ふんだけで十分です。",
      "今日は、誰にも見せないメモとして、5ふんだけ思考を置く場所を作ってください。",
      "今日は、前に進むためではなく、止まっている理由をやさしく見る5ふんだけを取ってください。",
      "今日は、作業を始める前に5ふんだけ「戻せる範囲」を決めてください。",
      "今日は、完成ではなく、気持ちの重さを一段下げるための5ふんだけを作ってください。",
      "今日は、怖さを消そうとせず、5ふんだけ隣に置いて眺めてみてください。",
      "今日は、誰にも提出しない前提で、5ふんだけ言葉の下書きを置いてください。",
      "今日は、正しく進むためではなく、安心できる小さな入口を探す5ふんだけにしてください。",
      "今日は、失敗しない方法を探す前に、5ふんだけ「失敗しても戻れること」を書いてください。",
      "今日は、気合いを入れずに、5ふんだけ今の気持ちを箇条書きにしてください。",
      "今日は、成果を出す時間ではなく、自分を責めないための5ふんだけを先に置いてください。",
      "今日は、誰かの目線をいったん外して、5ふんだけ自分の現在地を書いてください。",
      "今日は、動けない理由を責めずに、5ふんだけその理由をそのまま書いてください。",
      "今日は、完成形を考える前に、5ふんだけ「これなら試せる」を一つ探してください。",
      "今日は、怖さの奥にある本音を、5ふんだけ静かに拾う時間を作ってください。",
      "今日は、前進の証拠ではなく、思考を少し軽くするための5ふんだけで大丈夫です。"
    ],
  ...
  priority: {
    ...
    nextAction:
      "今日は、全部の中から「締切が近い」「5ふんで触れる」ものを1つだけ選んでください。選ばなかったものは、今日は持たなくて大丈夫です。",
